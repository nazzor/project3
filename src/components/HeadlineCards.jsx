const HeadlineCards = () => {
  return (
    <div>
      <h1 className="text-blue-500 font-bold text-4xl text-center pt-10">
        Top rated Coupons
      </h1>
      <div className="max-w-[1200px] mx-auto p-4 py-12 grid md:grid-cols-3 gap-6">
        ...
        <div className="rounded-xl relative overflow-hidden">
          ...
          <div className="absolute w-full h-full bg-black/30 text-white rounded-xl">
            ...
            <button className="border-white bg-white text-black py-3 px-5 rounded-md mx-4 absolute bottom-4">
              Order Now
            </button>
          </div>
          <img
